      ...
      <main className="bg-[#E7E7E7] min-h-screen px-4 md:px-20 pt-32 pb-12">
        ...
        >
          <div className="columns-1 sm:columns-2 md:columns-3 gap-4 space-y-4">
            {[
              ...
              <Image
                ...
                width={600}
                height={800}
                className={`w-full mb-4 rounded shadow object-cover shadow-xl fade-in-image opacity-0 translate-y-6 transition-all duration-[2000ms] ease-in-out delay-[${i * 150}ms]`}
              />
            ))}
          </div>
          <br />
          <Image
            ...
            width={600}
            height={800}
            className="w-full mb-4 rounded shadow object-cover shadow-xl fade-in-image opacity-0 translate-y-6 transition-all duration-[2000ms] ease-in-out delay-[1800ms]"
          />
        </section>
