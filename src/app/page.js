          ...
          <div className="relative z-10 h-[90vh] flex items-center">
            <div className="container mx-auto px-6 md:px-16">
              <div className="max-w-2xl">
                ...
                <h2 
                className="text-4xl md:text-7xl font-bold text-[#E7E7E7] mb-6 font-[playfair_display] leading-tight whitespace-nowrap
                            opacity-0 animate-[fadeIn_1s_ease-in-out_0.3s_forwards]"
                >
                  CREATIVE WORLD!
                </h2>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mt-16">
        {services.map((service, index) => (
          ...
          >
            <Link
              href={service.href}
              className="group block bg-white rounded-lg shadow-md hover:shadow-xl transform hover:-translate-y-2 transition-all duration-300 ease-in-out overflow-hidden h-96 border border-[#0D1321] flex flex-col items-center justify-center text-center"
            >
              <Image
  src={service.img}
  alt={service.title}
